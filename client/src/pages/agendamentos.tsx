      ...
      {isLoading ? (
        ...
        <div className="grid gap-4">
          {filteredAppointments.map((agendamento: any) => (
            <div key={agendamento.id} className="saber-card p-6 animate-scale-in">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4 flex-1">
                  <div className="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center">
                    <Calendar className="h-6 w-6 text-[#EA610B]" />
                  </div>

                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      <h3 className="text-lg font-bold text-foreground">{agendamento.titulo}</h3>
                      <Badge variant="outline" className="border-gray-200">{agendamento.tipo}</Badge>
                    </div>
                    ...
                    {agendamento.client && (
                      <div className="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
                        <div className="flex items-center gap-2 mb-2">
                          <Building className="h-4 w-4 text-[#EA610B]" />
                          <span className="font-semibold text-foreground">{agendamento.client.companyName}</span>
                        </div>
        ...
        <Card className="saber-card">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mb-4">
              <Calendar className="h-8 w-8 text-[#EA610B]" />
            </div>
